...
class ProfileIns extends StatefulWidget {
   ProfileIns({super.key, required this.companyId,});

  String companyId;

  @override
  State<ProfileIns> createState() => _ProfileInsState();
}

class _ProfileInsState extends State<ProfileIns> {
  @override
